                          ...
                          <div class="timeline-body">
                            ...
                            <div class="form-group clearfix">
                              <div class="icheck-success d-inline">
                                <input value="A" type="radio" name="<?php echo $a + 1; ?>" id="<?php echo $a + 1; ?>pila" <?php if ($preTest[$a]['answer'] == 'A') {
                                                                                                                            echo 'checked';
                                                                                                                          }  ?>>
                              ...
                              <br /><br />
                              <div class="icheck-success d-inline">
                                <input value="B" type="radio" name="<?php echo $a + 1; ?>" id="<?php echo $a + 1; ?>pilb" <?php if ($preTest[$a]['answer'] == 'B') {
                                                                                                                            echo 'checked';
                                                                                                                          }  ?>>
                              ...
                              <br /><br />
                              <div class="icheck-success d-inline">
                                <input value="C" type="radio" name="<?php echo $a + 1; ?>" id="<?php echo $a + 1; ?>pilc" <?php if ($preTest[$a]['answer'] == 'C') {
                                                                                                                            echo 'checked';
                                                                                                                          }  ?>>
                              ...
                              <br /><br />
                              <div class="icheck-success d-inline">
                                <input value="D" type="radio" name="<?php echo $a + 1; ?>" id="<?php echo $a + 1; ?>pild" <?php if ($preTest[$a]['answer'] == 'D') {
                                                                                                                            echo 'checked';
                                                                                                                          }  ?>>
                              ...
                              <br /><br />
                              <div class="icheck-success d-inline">
                                <input value="E" type="radio" name="<?php echo $a + 1; ?>" id="<?php echo $a + 1; ?>pile" <?php if ($preTest[$a]['answer'] == 'E') {
                                                                                                                            echo 'checked';
                                                                                                                          }  ?>>
