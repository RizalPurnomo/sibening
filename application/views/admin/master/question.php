                                            ...
                                            <div class="timeline-item">
                                                <h3 class="timeline-header">
                                                    <div class="card-body pad">
                                                        ...
                                                        <div class="mb-1">
                                                            <textarea class="textarea" id="question<?php echo $question[$a]['idquestion']; ?>" placeholder="Place some text here" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 5px;"><?php echo trim($question[$a]['question']); ?></textarea>
                                                        </div>
                                                    </div>
                                                </h3>
