                              ...
                              for ($a = 0; $a < $jum; $a++) { ?>
                                  ...
                                  ?>
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        <td><input name='nip[]' value='<?php echo $sheetData[$a]['1']; ?>'></td>
                                        <td><input name='date[]' value='<?php echo $sheetData[$a]['2']; ?>'></td>
                                        <td><input name='title[]' value='<?php echo $sheetData[$a]['3']; ?>'></td>
                                        <td><input name='instance[]' value='<?php echo $sheetData[$a]['4']; ?>'></td>
                                        <td><input name='jplapproved[]' value='<?php echo $sheetData[$a]['5']; ?>'></td>
                                        <td><input name='iddiklat[]' value='<?php echo $sheetData[$a]['6']; ?>'></td>
                                        <td><input name='idjenisdiklat[]' value='<?php echo $sheetData[$a]['7']; ?>'></td>
                                    </tr>
                                    <?php } ?>
                            <?php }
                            }
