                        ...
                        <div class="card-body">
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" style="width: 100%;" id="jenis">
                                            ...
                                            <?php for ($a = 0; $a < count($jenis); $a++) {  ?>
                                                <option value="<?php echo $jenis[$a]['id_jenis'] ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" style="width: 100%;" id="nama">
                                            <option value="">-- Pilih Jenis--</option>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" style="width: 100%;" id="typeaset">
                                            ...
                                            <?php for ($a = 0; $a < count($typeaset); $a++) {  ?>
                                                <option value="<?php echo $typeaset[$a]['id_type'] ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nilai" placeholder="Nilai Aset">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                <button onclick="saveData()" class="btn btn-info swalDefaultSuccess">Simpan</button>
